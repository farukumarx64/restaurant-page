...
<div class="carousel-inner">
    <div class="carousel-item active slide-1 vh-100 bg-cover">
    ...
    <div class="carousel-item  slide-2 vh-100 bg-cover">
        <div class="container h-100 d-flex align-items-center justify-content-center text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h6 class="text-white">WELCOME TO QRISPY</h6>
    ...
    <div class="carousel-item slide-3 vh-100 bg-cover">
        <div class="container h-100 d-flex align-items-center justify-content-center text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h6 class="text-white">WELCOME TO QRISPY</h6>
                    <h1 class="display-1 fw-bold text-white">Aesthetic Environment</h1>
                    <a href="#" class="btn btn-brand">Reservation</a>
                </div>
            </div>
        </div>
